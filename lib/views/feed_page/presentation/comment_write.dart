...
class PuddingCommentWrite extends StatefulWidget {
  const PuddingCommentWrite({super.key,});
...
class _PuddingFeedPageState extends State<PuddingCommentWrite> {
  ...
  Widget build(BuildContext context) {
    final heightSpacing = MediaQuery.sizeOf(context).height * (337/874);
    return Scaffold(
              ...
              child: PuddingTextFormField(
                ...
                suffixIcon: IconButton(
                  ...
                  icon: Transform.rotate(
                    ...
                    child: Icon(
                      Symbols.send,
                      color: focusNode.hasFocus ? PuddingColor.brown : PuddingColor.gray400,
                      fill: 1,
                    ),
                  ),
                ),
