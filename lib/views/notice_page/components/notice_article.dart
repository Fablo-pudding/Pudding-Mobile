...
class PuddingNoticeArticle extends StatefulWidget {
  final String title;
  ...
  @override
  State<PuddingNoticeArticle> createState() => _PuddingNoticeArticleState();
}

class _PuddingNoticeArticleState extends State<PuddingNoticeArticle> {
