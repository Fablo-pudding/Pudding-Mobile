...
class PuddingAdminNoticeWatchPage extends StatefulWidget {
  ...
  @override
  State<PuddingAdminNoticeWatchPage> createState() => _PuddingAdminNoticeWatchPageState();
}

class _PuddingAdminNoticeWatchPageState extends State<PuddingAdminNoticeWatchPage> {
              ...
              child: Container(
                ...
                child: SingleChildScrollView(
                  child: PuddingNoticeHeader(
                    ...
                    date: dateTimeFormat, edit: false,
                  ),
                ),
              ),
            ),
