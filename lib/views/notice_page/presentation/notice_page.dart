...
class PuddingNoticePage extends StatefulWidget {
  ...
  @override
  State<PuddingNoticePage> createState() => _PuddingNoticeState();
}

class _PuddingNoticeState extends State<PuddingNoticePage> {
  @override
            ...
            Expanded(
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index){
                    return PuddingNoticeArticle(title: '안녕하세요', writeDate: '등록일');
                  }),
            ),
          ],
        ),
